...
SYSTEMD_SERVICE_${PN} += "syslog-ecm.service"
SYSTEMD_SERVICE_${PN} += "powerstate_update.path"
SYSTEMD_SERVICE_${PN} += "powerstate_update.service"

FILES_${PN} += "${base_libdir}/rdk/* ${systemd_unitdir}/system/* ${sysconfdir}/${BPN}/*"
