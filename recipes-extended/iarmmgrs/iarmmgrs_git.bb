...
do_compile() {
    ...
    LDFLAGS="-lds-hal -ldshalsrv -ldl ${LDFLAGS}" oe_runmake -B -C ${S}/dsmgr/
    LDFLAGS="-liarmmgrs-ir-hal -ldshalcli -lds -lrfcapi ${LDFLAGS}" oe_runmake -B -C ${S}/ir/
    LDFLAGS="-ldshalcli -lds -liarmmgrs-power-hal -lrfcapi ${LDFLAGS}" oe_runmake -B -C ${S}/power/
    LDFLAGS="-ldshalcli -lds -liarmmgrs-power-hal -lrfcapi ${LDFLAGS}" oe_runmake -B -C ${S}/pwrstate/
