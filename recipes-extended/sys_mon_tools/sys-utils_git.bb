...
DEPENDS = "iarmbus iarmmgrs dbus glib-2.0 devicesettings directfb devicesettings-hal-headers trmmgr"
...
LDFLAGS += "-lpthread -lglib-2.0 -L. -lIARMBus -ldbus-1 -ldshalcli -ldl -lds -ltrm -ljansson -luuid"
